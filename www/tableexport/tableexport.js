...
$(function () {
	$('.dl_btn').on('click',function(){
		...
		//title = ($(this).siblings("table").attr("id"));
		//$(this).siblings("table").attr('id', title);
		$(this).html("");
		$(this).removeClass("dl_btn");
		$(this).siblings("table").tableExport({formats:["xlsx","csv"],bootstrap:false});
	});
});
